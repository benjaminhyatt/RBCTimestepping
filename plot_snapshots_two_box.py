...
def main(filename, start, count, output):
    ...
    # Plot settings
    tasks = ['buoyancy_2', 'buoyancy_1', 'vorticity_2', 'vorticity_1']
    #tasks = ['buoyancy_1', 'vorticity_1']
        ...
        for index in range(start, start+count):
            for n, task in enumerate(tasks):
                ...
                if n == 1:
                    titl = 'Buoyancy - Lower'
                if n == 2:
                    titl = 'Vorticity - Upper'
                if n == 3:
                    titl = 'Vorticity - Lower'
                #if n == 0:
                #    titl = 'Buoyancy'
                #if n == 1:
                #    titl = 'Vorticity'
                plot_tools.plot_bot_3d(dset, 0, index, axes=axes, title=titl, even_scale=True, visible_axes=False)
